...
const Admin: NextPage = () => {
  ...
  const eventsToShow = useMemo(() => {
    ...
    const filteredWhitelistEvents = reversed.filter((event: any, index: number): any => {
      const lastOccurrenceIndex = reversed.findIndex(
        (lastEvent: any, lastIndex: number) => lastIndex > index && lastEvent.args[0] === event.args[0],
      );
      return lastOccurrenceIndex === -1;
    });
    return filteredWhitelistEvents.filter((event: any) => event.args[1] === true);
  ...
  return (
    ...
    >
      <div className="mb-2 text-3xl font-bold text-center">Faucet ETH Aragua - {targetNetwork.name}</div>
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex flex-row justify-between col-span-2">
          ...
          <div className="flex flex-row justify-between w-3/5 col-span-2">
            <div className="flex flex-row justify-between">
              <input
                className="w-[50px] text-center border border-primary mr-2"
                type="number"
            ...
            <button
              className="text-white bg-primary btn btn-sm btn-primary hover:bg-info"
        ...
        <div className="mt-4 mb-2 text-white bg-primary">Whitelist | Cuentas intermediarias</div>
        {/* <MapWhitelisted /> */}
