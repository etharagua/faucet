...
export const Header = () => {
  ...
  return (
    <div className="sticky top-0 z-20 justify-between flex-shrink-0 px-0 shadow-md min-h-20 lg:static navbar bg-base-100 shadow-secondary sm:px-2">
      <div className="w-auto navbar-start lg:w-1/2">
        ...
        <Link href="/" passHref className="items-center hidden gap-2 ml-4 mr-6 lg:flex shrink-0">
          <>
            ...
            <Image alt="SE2 logo" className="cursor-pointer" fill src="/favicon.png" sizes="100%" priority />
            </div>
            <span className="text-xl font-bold text-center">ETH Aragua Faucet</span>
          </>
